...
st.sidebar.markdown("<p class='sidebar-text' style='margin-top: 10px;'>ይህ ሥርዓት የጤና መረጃን፣ የአኗኗር ዘይቤን እና የሕክምና ታሪክን በኤአይ እና በማሽን መማሪያ በመጠቀም የልብ ሕመም ስጋትን ለመተንበይ እና የልብና የደም ሥር ጤናን ለማሻሻል ግላዊ ምክሮችን ይሰጣል።</p>", unsafe_allow_html=True)
...
with row0_1:
    ...
    st.title("ኤአይ የተጎላበተ የልብ ሕመም ግምገማ መተግበሪያ")
    st.write("Unmatched Accuracy with Cutting-Edge Machine Learning Models")
    st.write("በላቁ የማሽን መማሪያ ሞዴሎች የማይተናነስ ትክክለኛነት")
st.write('---')
...
<div class="flex-container">
    <div class="flex-item introduction">
        ...
        <p>ኤአይ የተጎላበተ የልብ ሕመም ስጋት ግምገማ መተግበሪያ ለተጠቃሚዎች የልብ ሕመም ስጋታቸውን ለመቀነስ የሚረዱ ብጁ የስጋት ውጤቶችን እና ተግባራዊ ምክሮችን ይሰጣል። ይህ መተግበሪያ የላቀ ኤአይ እና ሞዴሊንግ ቴክኒኮችን በመጠቀም የልብና የደም ሥር ጤናዎን መጠበቅን ቀላል እና ተደራሽ ለማድረግ በቀላሉ ለመረዳት የሚችሉ ግምገማዎችን እና የመከላከያ እርምጃዎችን ይሰጣል።</p>
    </div>
    <div class="flex-item how-it-works">
        <h2>How it works | እንዴት እንደሚሰራ</h2>
        <ul>
            <li><strong>User Input / የተጠቃሚ መረጃ:</strong> Enter your health information, such as age, BMI, physical activity levels, smoking status, and medical history (e.g., heart attacks, strokes, diabetes). / እንደ ዕድሜ፣ BMI፣ የአካል ብቃት እንቅስቃሴ ደረጃዎች፣ የማጨስ ሁኔታ እና የሕክምና ታሪክዎን (ለምሳሌ፡ የልብ ድካም፣ ስትሮክ፣ ስኳር ሕመም) ያስገቡ።</li>
            <li><strong>Data Analysis / የውሂብ ትንተና:</strong> The app analyzes your input using advanced AI models specifically designed for heart disease risk prediction. / መተግበሪያው ያስገቡትን መረጃ ለልብ ሕመም ስጋት ትንበያ በተለይ በተዘጋጁ የላቁ ኤአይ ሞዴሎች ይተነትናል።</li>
            <li><strong>Risk Assessment / የስጋት ግምገማ:</strong> Receive a personalized risk score indicating your potential for heart disease. / ለልብ ሕመም ያለዎትን አቅም የሚያመለክት ግላዊ የስጋት ውጤት ይቀበላሉ።</li>
            <li><strong>Recommendations / ምክሮች:</strong> Get actionable advice to mitigate your risk, including lifestyle modification suggestions. / ስጋትዎን ለመቀነስ ተግባራዊ ምክሮችን ያገኛሉ፣ ይህም የአኗኗር ማሻሻያ ሀሳቦችን ያጠቃልላል።</li>
        </ul>
    </div>
</div>
...
if btn1:
        ...
        with row8_1:
            ...
            if risk > 25:
                ...
                feature_name_mapping = {
                    'ever_diagnosed_with_heart_attack': 'Heart Attack / የልብ ድካም',
                    'general_health': 'General Health / አጠቃላይ ጤንነት',
                    'ever_diagnosed_with_a_stroke': 'Stroke / ስትሮክ',
                    'ever_told_you_have_kidney_disease': 'Kidney Disease / የኩላሊት ሕመም',
                    'ever_told_you_had_diabetes': 'Diabetes / ስኳር ሕመም',
                    'physical_health_status': 'Physical Health / አካላዊ ጤንነት',
                    'ever_told_you_had_a_depressive_disorder': 'Depression / የመንፈስ ጭንቀት',
                    'sleep_category': 'Sleep / እንቅልፍ',
                    'age_category': 'Age / ዕድሜ',
                    'length_of_time_since_last_routine_checkup': 'Checkup Time / የምርመራ ጊዜ',
                    'BMI': 'BMI / ክብደት',
                    'smoking_status': 'Smoking / ማጨስ',
                    'exercise_status_in_past_30_Days': 'Exercise / የአካል ብቃት እንቅስቃሴ',
                    'binge_drinking_status': 'Binge Drinking / ከልክ በላይ አልኮል መጠጣት',
                    'drinks_category': 'Alcohol / አልኮል',
                    'could_not_afford_to_see_doctor': 'Doctor Access / የዶክተር ተደራሽነት',
                    'health_care_provider': 'Healthcare Provider / የጤና እንክብካቤ አቅራቢ',
                    'asthma_Status': 'Asthma / አስም',
                    'difficulty_walking_or_climbing_stairs': 'Mobility / የመንቀሳቀስ ችሎታ',
                    'mental_health_status': 'Mental Health / የአእምሮ ጤንነት',
                }
    ...
    st.write("""
        ...
        *This app is not a replacement for professional medical advice, diagnosis, or treatment.
        Always consult your doctor or a qualified healthcare provider with any questions you may have regarding your health.*
    """)
