...
st.sidebar.image("utils/ph4.jpg", use_container_width=True)
...
# Title with Amharic
st.markdown("""
    <h1 style='text-align: center; color: #004085; font-size: 36px;'>
    💊 የመድኃኒት ምክር ሥርዓት<br>Drug Recommendation System</h1>
""", unsafe_allow_html=True)

# Image Display
image = Image.open('utils/medss.jpg')
...
st.markdown("""
    <hr>
    <p style='text-align: center; color: #7f8c8d;'>Made by <span style='color: orange'>Addisu</span> | 
    <a href='' style='text-decoration:none'>Github</a> © 2026</p>
""", unsafe_allow_html=True)
